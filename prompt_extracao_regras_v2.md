# Prompt de Extração de Regras — v2
...
```json
{
  ...
  "regras": [
    ...
    {
      "id": "R18",
      "descricao": "Enviar principais comprovantes das atividades informadas no currículo (certificados de eventos, declarações de participação em grupos de pesquisa, projetos, monitorias etc.), conforme Anexo V.",
      "tipo": "obrigatória",
      "condicao": null,
    ...
    {
      "id": "R19",
      "descricao": "Enviar declaração de bolsista PAAE.",
      "tipo": "condicional",
      "condicao": "Apenas para candidatos bolsistas do Programa de Apoio e Assistência ao Estudante (PAAE).",
      "referencia": "Item 4.2 (i)"
    },
    {
      "id": "R20",
      "descricao": "Enviar laudo médico emitido nos últimos 12 meses, em papel timbrado, com CID, carimbo e assinatura do médico, atestando a espécie, o grau ou o nível da deficiência.",
      "tipo": "condicional",
